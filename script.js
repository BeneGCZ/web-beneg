...
const I18N = {
  cs: {
    ...
    f_h:"Časté otázky",
    f1_q:"Kolik stojí střih videa?", f1_a:"Cena se odvíjí od délky, náročnosti a termínu. Napiš mi, co potřebuješ, a do 24 hodin ti pošlu konkrétní nabídku.",
    f2_q:"Jak ti dodám materiál?", f2_a:"Nejjednodušeji přes Google Drive nebo MEGA — pošleš mi odkaz na surové záběry a případné podklady (loga, hudbu, reference).",
    f3_q:"Kolik revizí je v ceně?", f3_a:"Dvě kola úprav jsou v ceně vždy. Větší změny zadání nad rámec původního briefu řešíme individuálně.",
    f4_q:"Jak dlouho střih trvá?", f4_a:"Shorts a Reels obvykle do 2–3 dnů, delší YouTube videa podle rozsahu. Přesný termín si domluvíme předem a platí.",
    fl1:"Obchodní podmínky", fl2:"Ochrana osobních údajů", fl3:"FAQ",
  ...
  en: {
    ...
    f_h:"FAQ",
    f1_q:"How much does editing cost?", f1_a:"The price depends on length, complexity and deadline. Tell me what you need and I'll send you a specific quote within 24 hours.",
    f2_q:"How do I send you my footage?", f2_a:"Google Drive or MEGA works best — just send me a link to your raw footage and any assets (logos, music, references).",
    f3_q:"How many revisions are included?", f3_a:"Two rounds of revisions are always included. Bigger changes beyond the original brief are handled individually.",
    f4_q:"How long does editing take?", f4_a:"Shorts and Reels usually within 2–3 days, longer YouTube videos depending on scope. We agree on the deadline upfront — and it holds.",
    fl1:"Terms & Conditions", fl2:"Privacy Policy", fl3:"FAQ",
